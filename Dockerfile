...
WORKDIR /opt/
RUN wget https://github.com/Pigeoncoin/pigeoncoin/releases/download/v1.19.2.0/pigeon-ubuntu18-1.19.2.0.tar.gz
RUN tar zxvf pigeon-ubuntu18-1.19.2.0.tar.gz
